...
class ApiProfile
{
    ...
    init(id: String, age: Int, photos: [ApiPhoto], status: ApiProfileStatus?, distanceText: String?, lastOnlineText: String?, sex: String?, info: ApiUserProfileInfo, totalLikes: Int)
    {
        self.id = id
        self.age = age
        self.photos = photos
